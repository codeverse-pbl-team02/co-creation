        ...
        {!hideScreenTitle && (
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              {homeCourseFlow ? "AI가 최적 코스를 추천해드려요" : activeTab === "홈" ? "강서구 명지동 · 맑음 18°C" : activeTab === "코스" ? "AI가 최적 코스를 추천해드려요" : activeTab === "기록" ? "2026년 7월 누적 기록" : activeTab === "혜택" ? "러닝 완주로 적립한 혜택" : "함께 만드는 더 나은 부산"}
            </p>
          </div>
